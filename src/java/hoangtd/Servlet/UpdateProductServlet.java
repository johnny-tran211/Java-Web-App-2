...
public class UpdateProductServlet extends HttpServlet {
    ...
    private final String UPDATE_DETAIL_PAGE = "itemDetailAdmin.jsp";
    private final String UPDATE_PAGE = "StatusHistoryServlet";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String backupImage = request.getParameter("backupImage");
                ...
                if (user.getRole().equals("Admin")) {
                    ...
                    if (productName == null
                        ...
                        if (errorCheck == false) {
                            ...
                            boolean result = itemDAO.updateProduct(id, productName.trim(), quantity, imageStr, description.trim(), price, category.trim());
                            if (result) {
                                url = UPDATE_PAGE;
                                session.removeAttribute("ITEM");
                                request.setAttribute("UPDATE", productName.trim());
                                request.setAttribute("SUCCESS", "CREATE NEW PRODUCT SUCCESSFULLY");
                            } else {
                                request.setAttribute("FAILED", "CREATE NEW PRODUCT FAILED");
                            }
                        } else {
